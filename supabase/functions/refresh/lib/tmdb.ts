...
export async function fetchMovieBundle(
  ...
  return {
    ...
    tmdbRating: typeof json.vote_average === "number" ? json.vote_average : null,
    tmdbVotes: typeof json.vote_count === "number" ? json.vote_count : null,
    popularity: typeof json.popularity === "number" ? json.popularity : null,
